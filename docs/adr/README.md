...
| [0004](0004-treat-archive-as-document-visibility.md)                     | Amended by ADR 0005    | タスク文書のアーカイブを可視性属性として扱う                 |
| [0005](0005-treat-memo-archive-as-document-visibility.md)                | Accepted               | メモのアーカイブも可視性属性として扱う                       |
